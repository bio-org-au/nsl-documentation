...
WARNING: NSL simple name is deprecated and will be replaced by multiple service endpoints that cover specific purposes.
...
----
{
  "nslSimpleName": {
    ...
    "apni": true,
    "protoCitation": "Brown, R. (1810), Prodromus Florae Novae Hollandiae",
    "protoInstance": {
      "class": "au.org.biodiversity.nsl.Instance",
      "_links": {
        "permalink": {
