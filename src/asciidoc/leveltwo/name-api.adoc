...
**GET acceptable-name** gets a list of acceptable names given the simple name.
...
curl -H "Accept: application/json" -X GET https://biodiversity.org.au/nsl/services/api/name/acceptable-name.json?simpleName=%22poa%20fax%22
